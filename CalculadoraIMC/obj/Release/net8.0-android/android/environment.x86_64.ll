...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 103493644450245400, ; hash 0x16faeebd9f7ab18, from name: CalculadoraIMC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1939216399709123751, ; hash 0x1ae97b0a874634a7, from name: CalculadoraIMC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 42
	...
	%struct.DSOCacheEntry {
		i64 3288150010014545258, ; hash 0x2da1db03431d356a, from name: libaot-CalculadoraIMC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 83
	...
	%struct.DSOCacheEntry {
		i64 7901828546593283239, ; hash 0x6da8ef328bbbdca7, from name: aot-CalculadoraIMC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 191
	...
	%struct.DSOCacheEntry {
		i64 14169652601878210114, ; hash 0xc4a4b7f7a5a3e642, from name: libaot-CalculadoraIMC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 372
	...
	%struct.DSOCacheEntry {
		i64 16378096212974735557, ; hash 0xe34aafbb178790c5, from name: aot-CalculadoraIMC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 428
...
@.env.3 = private unnamed_addr constant [37 x i8] c"4902129b-9ee2-4032-9036-98340babd0ed\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.companyname.calculadoraimc\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [29 x i8] c"libaot-CalculadoraIMC.dll.so\00", align 16
