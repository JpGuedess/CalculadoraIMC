...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 840770158, ; hash 0x321d226e, from name: aot-CalculadoraIMC
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2197111441, ; hash 0x82f54291, from name: CalculadoraIMC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 238
	...
	%struct.DSOCacheEntry {
		i64 2267626001, ; hash 0x87293a11, from name: libaot-CalculadoraIMC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 250
	...
	%struct.DSOCacheEntry {
		i64 3130723352, ; hash 0xba9b0c18, from name: libaot-CalculadoraIMC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
	...
	%struct.DSOCacheEntry {
		i64 3182801763, ; hash 0xbdb5b363, from name: CalculadoraIMC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 368
	...
	%struct.DSOCacheEntry {
		i64 3213624717, ; hash 0xbf8c058d, from name: aot-CalculadoraIMC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CalculadoraIMC.dll.so
		ptr null; void* handle (0x0)
	}, ; 371
